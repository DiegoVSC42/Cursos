...
//        dadosSeries.add(dados);
    ...
    private void buscarEpisodioPorSerie() {
        ...
        if (serie.isPresent()) {
            ...
            // Verifica se a série já possui episódios armazenados
            if (serieEncontrada.getEpisodios() != null && !serieEncontrada.getEpisodios().isEmpty()) {
                System.out.println("Essa série já possui episódios armazenados:");
                serieEncontrada.getEpisodios().forEach(System.out::println);
                return; // Se já há episódios, finaliza o método para evitar duplicação
            }

            List<DadosTemporada> temporadas = new ArrayList<>();

            // Busca as temporadas e episódios da API
            ...
            // Mapeia as temporadas e episódios
            List<Episodio> episodios = temporadas.stream()
                    .flatMap(d -> d.episodios().stream()
                            .map(e -> new Episodio(d.numero(), e)))
                    .collect(Collectors.toList());

            // Salva os episódios na série
    ...
    private void buscarSeriePorAtor() {
        ...
        System.out.println("Séries em que " + nomeAtor + " trabalhou: " + seriesEncontradas.size());
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()) {
            ...
            System.out.println();
            topEpisodios.forEach(e -> System.out.printf("Serie: %s Temporada %s - Episódio %s - %s \n", e.getSerie().getTitulo(), e.getTemporada(), e.getNumeroEpisodio(), e.getTitulo()));
        }
    }
